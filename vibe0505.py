...
# # 여기만 네 토큰으로 바꿔
# # =========================
# KAGGLE_TOKEN="KGAT_704b6c43ade480d225b4e70a4ca12e33"
# 
# # 1) Kaggle 인증 세팅
# mkdir -p /root/.kaggle
...
files.download('/content/capstone_outputs/object_distribution_rgb_only.csv')
files.download('/content/capstone_outputs/object_distribution_rgb_only.png')